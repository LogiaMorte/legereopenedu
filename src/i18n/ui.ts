export const ui = {
  tr: {
    ...
    // About
    'about.title': 'OWL Nedir?',
    'about.p1': 'OWL (Open Workshop Lab), lisans, yüksek lisans ve doktora düzeyindeki araştırmacıların özellikle suç bilimi, sosyoloji, felsefe ve veri bilimi gibi alanların kesişiminde bir araya geldiği bağımsız bir akademik araştırma ağıdır.',
    'about.p2': 'Üç haftalık periyotlarla düzenlenen atölyelerde fikir paylaşımları yapılır, seminer ve kongre takvimleri tek bir havuzda yönetilir ve disiplinlerarası ortak yayınlar üretilmesi hedeflenir.',
    ...
    'contact.workshop.desc': 'Kendi araştırma atölyenizi tasarlayın, OWL altyapısıyla hayata geçirin.',
    ...
    'contact.invite.desc': 'Kurumunuzda OWL\'u misafir etmek istiyorsanız detayları konuşalım.',
    ...
    'ethics.manifesto.p1': 'OWL (Open Workshop Lab), bilginin özgürce üretildiği, paylaşıldığı ve tartışıldığı bağımsız bir akademik araştırma ağıdır. Kurumsal hiyerarşilerden bağımsız olarak, merak ve eleştirel düşünceyi temel alarak çalışırız.',
    ...
    'ethics.ip.p1': 'Atölye süresince üretilen tüm bireysel fikirler, notlar ve taslaklar, bunları üreten araştırmacıya aittir. OWL hiçbir koşulda bireysel fikri mülkiyet üzerinde hak iddia etmez.',
    ...
    'ethics.pub.p4': 'OWL, açık erişim (open access) yayıncılığı teşvik eder. Mümkün olduğunca araştırma çıktıları herkesin erişimine açık platformlarda paylaşılır.',
    ...
    'ethics.transparency.p3': 'OWL herhangi bir ticari, siyasi veya kurumsal çıkar gözetmez. Tüm faaliyetler akademik bağımsızlık ilkesiyle yürütülür.',
  ...
  en: {
    ...
    // About
    'about.title': 'What is OWL?',
    'about.p1': 'OWL (Open Workshop Lab) is an independent academic research network where undergraduate, graduate, and PhD-level researchers come together at the intersection of criminology, sociology, philosophy, and data science.',
    'about.p2': 'Through three-week workshop periods, participants share ideas, manage seminar and congress calendars in a unified pool, and aim to produce interdisciplinary joint publications.',
    ...
    'contact.workshop.desc': 'Design your own research workshop and bring it to life with OWL infrastructure.',
    ...
    'contact.invite.desc': 'Host OWL at your institution — let\'s discuss the details.',
    ...
    'ethics.manifesto.p1': 'OWL (Open Workshop Lab) is an independent academic research network where knowledge is freely produced, shared, and debated. We operate independently of institutional hierarchies, grounded in curiosity and critical thinking.',
    ...
    'ethics.ip.p1': 'All individual ideas, notes, and drafts produced during a workshop belong to the researcher who created them. OWL never claims rights over individual intellectual property under any circumstances.',
    ...
    'ethics.pub.p4': 'OWL encourages open access publishing. Whenever possible, research outputs are shared on platforms accessible to everyone.',
    ...
    'ethics.transparency.p3': 'OWL does not pursue any commercial, political, or institutional interests. All activities are conducted under the principle of academic independence.',
